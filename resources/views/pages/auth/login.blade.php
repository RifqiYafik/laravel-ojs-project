...
<head>
    ...
    <meta content="width=device-width, initial-scale=1, maximum-scale=1, shrink-to-fit=no"
        name="viewport">
    <title>Login &mdash; OJS Project</title>
        ...
        <section class="section">
            <div class="d-flex align-items-stretch flex-wrap">
                <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
                    <div class="m-3 p-4">
                        <img src="{{ asset('img/logo-ojs.png') }}"
                            alt="logo"
                            width="80"
                            class="shadow-light rounded-circle mb-5 mt-2">
                        <h4 class="text-dark font-weight-normal">Welcome to <span class="font-weight-bold">OJS Project</span>
                        </h4>
                        ...
                        <form method="POST"
                            ...
                            <div class="mt-5 text-center">
                                Don't have an account? <a href="{{route('journaluser.register')}}">Create new one</a>
                            </div>
                        </form>

                        <div class="text-small mt-5 text-center">
                            Copyright &copy; Our Project. Made with 💙 by OJS Project Team
                            <div class="mt-2">
